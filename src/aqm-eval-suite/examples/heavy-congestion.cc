...
/*
 * This example is equivalent to the scenario described in Section 8.2.4
 * of RFC 7928 (https://tools.ietf.org/html/rfc7928#section-8.2.4).
 */
...
NS_LOG_COMPONENT_DEFINE ("HeavyCongestion");

class HeavyCongestion : public ScenarioImpl
{
public:
  HeavyCongestion ();
  ~HeavyCongestion ();
